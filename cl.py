...
import signal
from clash_generator import generate_clash_configs
...
FIN_PATH="final.txt"
FILE_HEADER_TEXT = """//profile-title: base64:My Sub=
"""
FIN_CONF=[]
CHECK_LOC=True
CHECK_IRAN=True
...
if __name__ == "__main__":
    ...
    tagged_configs = set_initial_tag(cleaned_configs, "My Config")
    ...
    clash_proxies_count = generate_clash_configs(FIN_CONF, "clash.yaml", "clash_meta.yaml")
